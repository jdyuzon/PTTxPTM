...
refPTM=~/references/Wyatt_Ellwood_assemblies/15A.fasta
merged_genome=~/references/PTTxPTT_genome/merged_genome_PTTxPTT.fasta
####index fasta
...
############################################################
nucmer -mum -mincluster 65 -minmatch 40 --prefix=${nucmer}${entry} ~/references/hybrid_references/PTT_0-1_assembly.v14.fa ${entry}.PTMPTT.fasta
